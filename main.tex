...
\documentclass[
  ...
  paper=a4,
  fontsize=11pt, 
  gutter=25mm,      % Inner Margin (Binding)
  fore_edge=40mm,   % <--- Outer Margin (Edge) - Set this explicitly!
  head_space=30mm,
...
\ModifyHeading{subsection}{font={\HeadSans\mdseries\large}}
